...
<script>
  ...
  $('#adminLoginForm').submit(function(event) {
    ...
    console.log(response); // Adiciona isso para ver a resposta no console do navegador
    response = response.trim();
    if (response === 'success') {
        window.location.href = 'indexAdm.php';
    } else {
        alert('Erro: ' + response); // Mostra a mensagem de erro completa
    }
}
    });
  });
...
<script>
  // Adiciona o ID da empresa ao formulário antes de enviar
